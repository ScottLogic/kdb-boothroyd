...
describe ("Server Management", function () {
  ...
  describe("Edit Server", function () {
    ...
    it ("should display the correct details if I select a server", async function () {
      ...
      assert.strictEqual(await nameField.inputValue(), "Test 1", "Name field is not correct")
      assert.strictEqual(await hostField.inputValue(), "0.0.0.0", "Host field is not correct")
      assert.strictEqual(await portField.inputValue(), "5001", "Port field is not correct")
      assert.strictEqual(await tlsCheck.isChecked(), false, "TLS checkbox is not correct")
    ...
    it ("should let me update the details", async function () {
      ...
      assert.strictEqual(await hostField.inputValue(), "0.0.0.0", "Host field is not correct")
      assert.strictEqual(await portField.inputValue(), "5001", "Port field is not correct")
      assert.strictEqual(await tlsInput.isChecked(), false, "TLS checkbox is not correct")
      assert.strictEqual(await saveButton.getAttribute("aria-disabled"), "true", "Save button is not disabled")
      ...
      assert.strictEqual(await nameField.inputValue(), "Test Server", "Name field is not correct")
      assert.strictEqual(await hostField.inputValue(), "127.0.0.1", "Host field is not correct")
      assert.strictEqual(await portField.inputValue(), "5002", "Port field is not correct")
      assert.strictEqual(await tlsInput.isChecked(), true, "TLS checkbox is not correct 1")
      assert.strictEqual(await saveButton.getAttribute("aria-disabled"), null, "Save button is still disabled")
      ...
      assert.strictEqual(await hostField.inputValue(), "127.0.0.1", "Host field is not correct")
      assert.strictEqual(await portField.inputValue(), "5002", "Port field is not correct")
      assert.strictEqual(await tlsInput.isChecked(), true, "TLS checkbox is not correct 2")
      assert.strictEqual(await saveButton.getAttribute("aria-disabled"), "true", "Save button is not disabled")
